...
return [
    ...
    'older_than' => 'Минимальный возраст для регистрации 18 лет.',
    'old_pass' => 'Указанный пароль не соответствует паролю в базе данных.',

    'custom' => [
        'checkbox' => [
            'in' => 'Вы должны дать согласие на обработку данных.',
        ],
    ],

    'extensions' => 'Поле :attribute должно быть файлом одного из следующих типов: :values.',
    'recaptcha' => 'Captcha не валидна.',
    ...
    'attributes'  => [
        ...
        'notes' => 'Примечания',
        'game_id' => 'Игры',
        'characteristics.game_type' => 'Тип игры',
        'characteristics.chronics' => 'Хроники',
        'characteristics.addons' => 'Аддоны',
