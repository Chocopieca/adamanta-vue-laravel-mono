...
return [
    ...
    'older_than' => 'Мінімальний вік для реєстрації 18 років.',
    'old_pass' => 'Зазначений пароль не відповідає паролю в базі даних.',

    'custom' => [
        'checkbox' => [
            'in' => 'Ви повиннi дати згоду на обробку данних.',
        ],
    ],
    ...
    'attributes'           => [
        ...
        'notes' => 'примітки',
        'game_id' => 'гри',
        'characteristics.game_type' => 'тип гри',
        'characteristics.chronics' => 'хроніки',
        'characteristics.addons' => 'адоны',
