...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_tabs_component__ = __webpack_require__(3);
...
Nova.booting(function (Vue, router) {
    Vue.component('index-form-translations', __webpack_require__(4));
    Vue.component('detail-form-translations', __webpack_require__(7));
    Vue.component('form-form-translations', __webpack_require__(10));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_laravel_nova__ = __webpack_require__(15);
    ...
    methods: {
        changeSelect: function changeSelect(event) {
            ...
            this.$nextTick(function () {
                _this.fields = _this.field.trans[event.target.value - 1].fields;
                _this.show = 1;
            });
        },
        ...
        fill: function fill(formData) {
            ...
            var fields = [];
            this.field.trans.forEach(function (item) {
                var trans = { language_id: item.lang.id };
            ...
            formData.append(this.field.attribute, JSON.stringify({
                data: fields, options: this.field.options
            }) || '');
        },
        ...
        setFieldsForCurrentLanguage: function setFieldsForCurrentLanguage() {
            var _this2 = this;

            this.field.trans[this.currentLanguage].fields.forEach(function (item, key) {
                _this2.field.trans[_this2.currentLanguage].fields[key].value = _this2.$children[key].value;
            });
        }
    }
});
...
var render = function() {
  ...
  return _c(
    "div",
    [
      _c("h3", { staticClass: "py-6 px-8" }, [_vm._v(_vm._s(_vm.field.title))]),
      _vm._v(" "),
          ...
          _c("div", { staticClass: "py-6 px-8 w-1/2" }, [
            _c(
              "select",
              {
                ...
                staticClass: "w-2/6 form-control form-select",
                ...
                _vm._l(_vm.languages, function(option) {
                  return _c(
                    "option",
                    {
                      domProps: {
                        value: option.id,
                        selected: option.id == _vm.language
                      }
                    },
                    [
                      _vm._v(
      ...
      _vm._v(" "),
      _vm._l(_vm.fields, function(trans) {
        return _vm.show
          ? _c(
              "div",
              [
                _c("form-" + trans.component, {
                  tag: "component",
                  attrs: {
                  ...
                  on: { "file-deleted": _vm.updateLastRetrievedAtTimestamp }
                })
              ],
              1
            )
